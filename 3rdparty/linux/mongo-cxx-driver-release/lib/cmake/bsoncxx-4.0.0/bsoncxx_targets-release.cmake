...
set_target_properties(mongo::bsoncxx_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libbsoncxx.so.4.0.0"
  IMPORTED_SONAME_RELEASE "libbsoncxx.so._noabi"
  )

list(APPEND _cmake_import_check_targets mongo::bsoncxx_shared )
list(APPEND _cmake_import_check_files_for_mongo::bsoncxx_shared "${_IMPORT_PREFIX}/lib/libbsoncxx.so.4.0.0" )
